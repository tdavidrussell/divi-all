...
-->
			<!--
				Text not image logo, https://www.elegantthemes.com/forum/viewtopic.php?f=187&t=459971

				-->
			<div class="logo_container">
				<span class="logo_helper"></span>
				<a class="logo-a" href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<div id="logo" style="font-size: 2em;">
						<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>
						<?php echo '<br><span class="blog-description" style="font-size: .6em;">'; ?>
